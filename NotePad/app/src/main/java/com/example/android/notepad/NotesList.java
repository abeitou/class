...
public class NotesList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layoutView = getLayoutInflater().inflate(R.layout.search_item, null);
        Button btnSearch = (Button) layoutView.findViewById(R.id.search);
        final EditText etTitle = (EditText) layoutView.findViewById(R.id.title);
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor cursor = managedQuery(
                        getIntent().getData(),            // Use the default content URI for the provider.
                        PROJECTION,                       // Return the note ID and title for each note.
                        "title LIKE '%"+title+"%'",                             // No where clause, return all records.
                        null,                             // No where clause, therefore no where column values.
                        NotePad.Notes.DEFAULT_SORT_ORDER  // Use the default sort order.
                );
                SimpleCursorAdapter adapter
        ...
        getListView().addHeaderView(layoutView);
